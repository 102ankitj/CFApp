...
from rest_framework.decorators import \
    permission_classes  #Import permission class to allow or deny access to resources for different users
...
class IngredientSerializer(
    serializers.HyperlinkedModelSerializer):  #Creating a serializer class object named IngredientSerializer
    class Meta:  #Service class
...
class CakeSerializer(serializers.HyperlinkedModelSerializer):  #Creating a serializer class object named CakeSerializer
    ingredients = IngredientSerializer(read_only=True,
                                       many=True)  #Initializing Ingredients as it's many to many field object;
...
class OrderItemSerializer(
    serializers.HyperlinkedModelSerializer):  #Creating a serializer class object named OrderItemSerializer
    class Meta:  #Service class
        model = OrderItem  #Set model as OrderItem model
        fields = (
        'url', 'id', 'related_order', 'product', 'quantity')  #Specify the fields to be viewed in OrderItem API
...
class OrderSerializer(
    serializers.HyperlinkedModelSerializer):  #Creating a serializer class object named OrderSerializer
